        ...
        <div className="my-20">
            ...
            <div className="flex flex-wrap justify-center">
                {REVIEWS.reviews.map((review, index) => (
                    ...
                    items-center justify-center rounded-2xl border border-neutral-300 p-10 mx-2 max-w-xs">
                    <p className="mb-4"> {review.review}
                    </p>

                    <div className="flex items-center mt-4">
                        <img src={review.image} alt={review.name} className="w-12 h-12 rounded-full m-4"/>
                        <div>
